...
const esModuleIndicator = template(`
...
export default function ({types: t}) {
  ...
  const ui5Visitor = {
    StringLiteral(path) {
      /**
       * Remove all occurencies of `Object.defineProperty(exports, "__esModule", { value: true });` which are generated by TypeScript,
       * since we anyway cannot be 100% spec compliant and they were causing trouble when there's no export at all.
       */
      if (path.node.value === '__esModule'
        && path.parentPath
        && t.isNodesEquivalent(path.parentPath.parent, esModuleIndicator)) {
